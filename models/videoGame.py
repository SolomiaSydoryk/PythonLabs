...
class VideoGame(Game):
    ...
    def __str__(self):
        return f"VideoGame(publisher={self.publisher}, tittle={self.tittle}, year={self.year}, genre={self.genre}, " \
               f"number_of_parts={self.number_of_parts}, min_players={self.min_players}, " \
